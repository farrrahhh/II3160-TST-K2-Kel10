    ...
    <style>
        * {
        ...
        .left-section::before {
            ...
            width: 100%;
            height: 100%;
            background: url('<?= base_url("images/pict(5).png") ?>') center/cover no-repeat;
            z-index: 1;
        }
...
<body>
    ...
    <section class="right-section">
        ...
        <div class="form-container">
            ...
            <form action="/MediMart/login" method="POST">
                ...
                <div class="links">
                    <a href="/MediMart/register">Don't have an account?</a>
